...
public class ExecuteJavaInTheBrowserView extends AbstractThing {
    ...
    public ExecuteJavaInTheBrowserView() {
        ...
        add(md("""
                Java powers a great deal of the internet's most busiest websites. But
                what many Java developers didn't realize that you *can* run Java inside your browser sandbox too. And
