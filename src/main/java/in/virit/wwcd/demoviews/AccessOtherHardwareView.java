...
public class AccessOtherHardwareView extends AbstractThing {
    ...
    public AccessOtherHardwareView() {
        add(md("""
                Contrary to popular belief, you can actually do quite a lot with web and devices. Chromium-based
                browsers even allow you to directly access Bluetooth, Serial and USB ports 🤯
